  ...
  return (
    <React.Fragment>
      ...
      <p className="py-2.5 text-[13px]">
        ...
        account or a strategy account you are following, select the account from
      ...
      <p className="py-2.5 text-[13px]">
        ...
        strategy account you are following, select the account from the dropdown
        and click <strong>Trade History</strong>.
      </p>
      <p className="py-2.5 text-[13px]">
        For a list of historical trades within a given date range of any
        personal account or strategy account you are following, select the date
