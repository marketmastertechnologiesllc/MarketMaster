  ...
  const handleCreateAccount = async () => {
    try {
      ...
      if (
        ...
        values.server == '' ||
        values.platform == '' ||
        user.role === 'User' ? false: values.copyFactoryRoles.length === 0
      ) {
      ...
      <div className="py-0 px-[200px]">
        ...
        <div className="mb-[20px] rounded bg-[#282D36] text-white">
          ...
          <div className="p-[15px] bg-[#2E353E] box-border">
            ...
            <div className="flex justify-start pb-[15px] mb-[15px] border-b-[1px] border-[#242830]">
              ...
              <div className="w-1/2 px-[15px]">
                ...
                {/* <select
                  ...
                  value={values.server}
                  required
                  className="block bg-[#1a1c1f] text-[#fff] px-3 py-1.5 rounded w-full h-[34px] text-sm"
                  onChange={handleInputChange}
                >
                  ...
                  {brokers.map((item, idx) => (
                    <option key={`server${idx}`} value={item.name}>
                      {item.name}
                    </option>
                  ))}
                </select> */}
            ...
            <div
              className={`flex justify-start ${user.role === 'User'
                  ? ''
