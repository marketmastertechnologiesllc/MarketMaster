...
const initialHeaders = [
  { id: 'accountId', label: 'Account ID', checked: true },
  { id: 'copyFactoryRoles', label: 'Copy Factory Roles', checked: true },
  { id: 'platform', label: 'Platform', checked: true },
  { id: 'login', label: 'Login', checked: true },
  { id: 'name', label: 'Name', checked: true },
  { id: 'server', label: 'Server', checked: true },
...
export default function Accounts() {
  ...
  const [deleteAccountModalShow, setDeleteAccountModalShow] = React.useState(false);
              ...
              >
                {isDataLoading ? (
                  ...
                  <TableRow>
                    ...
                    >
                      <div className="flex flex-col justify-center items-center">
                        <AccountBalanceIcon sx={{ fontSize: 48, color: '#666', mb: 2 }} />
                        <span className="text-[#E9D8C8] text-lg font-medium">No accounts found</span>
                        <span className="text-[#E9D8C8] text-sm opacity-70 mt-1">Add your first account to get started</span>
                      </div>
                    </TableCell>
                  </TableRow>
                )}
