  ...
  return (
    <div className='flex flex-col justify-center bg-[#0B1220] text-[#E9D8C8] text-center h-full fixed top-0 right-0 left-0 bottom-0'>
      <div className="max-w-4xl mx-auto px-6 py-12 bg-[#0B1220] rounded-xl border border-[#11B3AE] shadow-[0_0_16px_rgba(17,179,174,0.5)]">
        <h1 className='text-4xl md:text-5xl my-6 font-semibold text-[#E9D8C8]'>Your account successfully registered and now verify your email</h1>
        <h1 className='text-2xl md:text-3xl my-4 text-[#E9D8C8]'>We just sent an email to the address: <span className="text-[#11B3AE] font-semibold">{signupEmail}</span></h1>
