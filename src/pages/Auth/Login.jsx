...
import Logo from '../../assets/img/dark-logo-text.png';
    ...
    <div className="w-screen h-screen flex flex-col items-center justify-center text-white">
      <div className="block max-w-md pt-2 w-full">
        <div className="flex flex-row justify-between h-10 relative">
          <img className='scale-[2] absolute -top-5 left-0' style={{ height: '80px', width: '120px' }} src={Logo} alt="" />
          <div className="absolute top-0 right-0 px-[17px] py-[13px] rounded-md rounded-b-none bg-[#0088cc] text-[12px] flex flex-row items-center">
            <svg
